...
public partial class EngineeringWorkspaceControl : UserControl, IDisposable
{
    public const double CompactWidth = 420;
    public const double CompactHeight = 340;
    public const double CompactHelpHeight = 440;
    public const double FullMinWidth = 920;
    public const double FullMinHeight = 620;
    public const double FullMaxWidth = 1180;
    public const double FullMaxHeight = 760;
    ...
    private bool fullAssistantVisible = true;
    ...
    public EngineeringWorkspaceControl()
    {
        InitializeComponent();

        CategoryFilter.ItemsSource =
            EngineeringLocalization.CategoryFilters;
        CategoryFilter.SelectedIndex =
            0;

        service.StateChanged +=
            OnStateChanged;
        service.Catalog.CatalogChanged +=
            OnCatalogChanged;
    ...
    public void ConfigureOverlayPresentation()
    {
        OverlayCloseButton.Visibility =
            Visibility.Visible;
    ...
    public void ApplyInteractionHint(
        bool canInteract)
    {
    ...
    private void OverlayCloseButton_Click(
        object sender,
        RoutedEventArgs e) =>
        CloseRequested?.Invoke();

    private void OpenFullAssistantButton_Click(
        object sender,
        RoutedEventArgs e)
    {
